<div class="row">
  ...
  <div class="col-12">
    <div class="alert alert-info" role="alert">
      <h4>Showing <b><?php echo ucfirst($data["service"]); ?></b> Sales Analysis From <?php echo $data["datefrom"]; ?>
        To <b><?php echo $data["dateto"]; ?></b></h4>
    </div>
  </div>
          ...
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div>
                ...
                <p class="mb-0 text-muted text-right">Net Profit</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row no-gutters py-2 border-top">
        <div class="col-12 col-lg-3">
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
              <div>
                <i class="fa fa-arrow-down text-success font-size-40"></i><br>
              </div>
              <div>
                <h3 class="text-success my-0 text-right">N<?php echo $data["inflow"]; ?></h3>
                <p class="mb-0 text-muted text-right">Inflow</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-3">
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
              <div>
                <i class="fa fa-arrow-up text-danger font-size-40"></i><br>
              </div>
              <div>
                <h3 class="text-danger my-0 text-right">N<?php echo $data["outflow"]; ?></h3>
                <p class="mb-0 text-muted text-right">Outflow</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-3">
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
              <div>
                <i class="fa fa-exchange text-info font-size-40"></i><br>
              </div>
              <div>
                <h3 class="text-info my-0 text-right">N<?php echo $data["dexInflow"]; ?></h3>
                <p class="mb-0 text-muted text-right">DEX Inflow</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12 col-lg-3">
          <div class="box-body br-1 border-light no-radius">
            <div class="d-flex align-items-center justify-content-between">
              <div>
                <i class="fa fa-exchange text-warning font-size-40"></i><br>
              </div>
              <div>
                <h3 class="text-warning my-0 text-right">N<?php echo $data["dexOutflow"]; ?></h3>
                <p class="mb-0 text-muted text-right">DEX Outflow</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="modal-body">
        <form method="POST" class="form-submit row">
          ...
          <div class="form-group  col-md-6">
            ...
            <div class="">
              <input type="datetime-local" name="datefrom" placeholder="Date From" class="form-control"
                required="required">
            </div>
          </div>
          ...
          <div class="form-group col-12">
            <div class="d-flex justify-content-between">
              <button type="submit" name="filterSalesResult" class="btn btn-info btn-submit"><i class="fa fa-search"
