                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <h4 class="text-dark"><b>(<?php echo $data["airtimeTransactions"]; ?>
                                            Transactions)</b></h4>
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <h4 class="text-dark"><b>(<?php echo $data["dataTransactions"]; ?> Transactions)</b>
                                    </h4>
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <h4 class="text-dark"><b>(<?php echo $data["dataPinTransactions"]; ?>
                                            Transactions)</b></h4>
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <h4 class="text-dark"><b>(<?php echo $data["cableTransactions"]; ?>
                                            Transactions)</b></h4>
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <h4 class="text-dark"><b>(<?php echo $data["electricityTransactions"]; ?>
                                            Transactions)</b></h4>
                                </td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <h4 class="text-dark"><b>(<?php echo $data["examTransactions"]; ?> Transactions)</b>
                                    </h4>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <i class="fa fa-arrow-down text-success font-size-50"></i><br><br />
                                    <h4 class="text-dark"><b>Total <br /> Inflow</b></h4>
                                    <h2 class="text-success">N<?php echo $data["inflow"]; ?></h2>
                                </td>

                                <td>
                                    <i class="fa fa-arrow-up text-danger font-size-50"></i><br><br>
                                    <h4 class="text-dark"><b>Total <br /> Outflow</b></h4>
                                    <h2 class="text-danger">N<?php echo $data["outflow"]; ?></h2>
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <i class="fa fa-exchange text-info font-size-50"></i><br><br />
                                    <h4 class="text-dark"><b>DEX <br /> Inflow</b></h4>
                                    <h2 class="text-info">N<?php echo $data["dexInflow"]; ?></h2>
                                </td>

                                <td>
                                    <i class="fa fa-exchange text-warning font-size-50"></i><br><br>
                                    <h4 class="text-dark"><b>DEX <br /> Outflow</b></h4>
                                    <h2 class="text-warning">N<?php echo $data["dexOutflow"]; ?></h2>
                                </td>
                            </tr>

                            <tr>
                                <td>
                                    <i class="fa fa-undo text-danger font-size-50"></i><br><br />
                                    <h4 class="text-dark"><b>Refund <br /> Flow</b></h4>
                                    <h2 class="text-danger">N<?php echo $data["refundFlow"]; ?></h2>
                                </td>

                                <td>
                                    <i class="fa fa-money text-success font-size-50"></i><br><br>
                                    <h4 class="text-dark"><b>Net <br /> Profit</b></h4>
                                    <h2 class="text-success">N<?php echo $data["profit"]; ?></h2>
                                </td>
                            </tr>
