...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li>
        <a href="<?php echo $urlAddon; ?>blockchain">
          <i class="fa fa-link"></i> <span>Blockchains</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-right pull-right"></i>
          </span>
        </a>
      ...
      <li>
        <a href="<?php echo $urlAddon; ?>tokens">
          <i class="fa fa-circle-o"></i> <span>Tokens</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-right pull-right"></i>
          </span>
        </a>
      ...
      <li>
        <a href="<?php echo $urlAddon; ?>earning-setting">
          <i class="fa fa-money"></i> <span>Earning Setting</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-right pull-right"></i>
          </span>
        </a>
